...
class ProductDetailReviewViewRatingPercentIndicator extends StatefulWidget {
  ...
  ProductDetailReviewViewRatingPercentIndicator({
    Key? key,
  ...
  State<StatefulWidget> createState() =>
      _ProductDetailReviewViewRatingPercentIndicatorState();
}

class _ProductDetailReviewViewRatingPercentIndicatorState
    extends State<ProductDetailReviewViewRatingPercentIndicator>
  ...
  void _checkIfNeedCancelAnimation(
      ProductDetailReviewViewRatingPercentIndicator oldWidget) {
